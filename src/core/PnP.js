...
export class PnP {
  ...
  _cleanUpConnObj(connectObj) {
    ...
    connectObj.host = connectObj.host || HOSTURL;
    connectObj.identityProvider = connectObj.identityProvider || "";
    this._connectObject = connectObj;
    return connectObj;
  }
  async connect(
    wallet,
    connectObj = { whitelist: [], host: HOSTURL, identityProvider: "" }
  ) {
