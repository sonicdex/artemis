    ...
    connectWallet: async function (connectObj = { whitelist: [], host: '' }) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (isICXReady) {
                ...
                if (!isconneted) {
                    await window.icx.connect({ ...window.ic.astrox.connectOptions, delegationTargets: connectObj.whitelist, ledgerHost: connectObj.host })
                }
                ...
                self.createActor = async function (connObj = { canisterId: '', interfaceFactory: false }) {
                    ...
                    return await window.icx.createActor(connObj.canisterId, connObj.interfaceFactory);
                };
